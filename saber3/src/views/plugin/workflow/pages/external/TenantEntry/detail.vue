    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '税收', prop: 'taxRevenue', type: 'input', span: 24, readonly: true },
          { label: '法人', prop: 'principalName', type: 'input', span: 12, readonly: true },
          { label: '法人联系方式', prop: 'principalPhone', type: 'input', span: 12, readonly: true },
          { label: '财务联系人', prop: 'financeContactName', type: 'input', span: 12, readonly: true },
          { label: '财务联系方式', prop: 'financeContactPhone', type: 'input', span: 12, readonly: true },
          { label: '意向楼层', prop: 'leaseFloorArea', type: 'input', span: 12, readonly: true },
          { label: '免租期', prop: 'rentFreePeriod', type: 'input', span: 12, readonly: true },
          { label: '租金', prop: 'unitPrice', type: 'input', span: 12, readonly: true },
          ...
          { label: '情况说明', prop: 'approvalMatter', type: 'textarea', span: 24, readonly: true },
          {
            label: '附件',
            prop: 'attachment',
            type: 'upload',
