...
CREATE TABLE `blade_attach`  (
  ...
  `domain_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '附件域名',
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_client` (`id`, `client_id`, `client_secret`, `resource_ids`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `create_user`, `create_dept`, `create_time`, `update_user`, `update_time`, `status`, `is_deleted`) VALUES (1123598811738675201, 'sword', 'sword_secret', NULL, 'all', 'authorization_code,password,refresh_token,captcha,social,sms_code,register', 'http://localhost:8888', NULL, 3600, 604800, NULL, NULL, 1123598815738675201, 1123598813738675201, '2019-03-24 10:40:55', 1123598815738675201, '2019-03-24 10:40:59', 1, 0), (1123598811738675202, 'saber', 'saber_secret', NULL, 'all', 'authorization_code,password,refresh_token,captcha,social,sms_code,register', 'http://localhost:1888', NULL, 3600, 604800, NULL, NULL, 1123598815738675201, 1123598813738675201, '2019-03-24 10:42:29', 1123598815738675201, '2019-03-24 10:42:32', 1, 0), (1123598811738675203, 'saber3', 'saber3_secret', NULL, 'all', 'authorization_code,password,refresh_token,captcha,social,sms_code,register', 'http://localhost:2888/login', NULL, 3600, 604800, NULL, NULL, 1123598815738675201, 1123598813738675201, '2024-04-01 00:00:00', 1123598815738675201, '2024-04-01 00:00:00', 1, 0), (1123598811738675204, 'rider', 'rider_secret', NULL, 'all', 'authorization_code,password,refresh_token,captcha,social,sms_code,register', 'http://localhost:88', NULL, 3600, 604800, NULL, NULL, 1123598815738675201, 1123598813738675201, '2024-04-01 00:00:00', 1123598815738675201, '2024-04-01 00:00:00', 1, 0);
COMMIT;
...
CREATE TABLE `blade_code`  (
  `id` bigint NOT NULL COMMENT '主键',
  `model_id` bigint NULL DEFAULT NULL COMMENT '数据模型主键',
  `menu_id` bigint NULL DEFAULT NULL COMMENT '上级菜单主键',
  ...
  `author` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '作者信息',
  `sub_model_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '子表模型主键',
  `sub_fk_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '子表绑定外键',
  `tree_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '树主键字段',
  `tree_pid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '树父主键字段',
  `tree_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '树名称字段',
  `base_mode` int NULL DEFAULT NULL COMMENT '基础业务模式',
  `wrap_mode` int NULL DEFAULT NULL COMMENT '包装器模式',
  `feign_mode` int NULL DEFAULT NULL COMMENT '远程调用模式',
  `code_style` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '代码风格',
  ...
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成器表';
...
-- ----------------------------
DROP TABLE IF EXISTS `blade_code_setting`;
CREATE TABLE `blade_code_setting`  (
  ...
  `code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '编号',
  `category` int NULL DEFAULT 1 COMMENT '分类 1:默认配置, 2:表单设计',
  `settings` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '配置项',
  `status` int NULL DEFAULT 1 COMMENT '状态',
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成器配置表';
...
CREATE TABLE `blade_datasource`  (
  `id` bigint NOT NULL COMMENT '主键',
  `category` int NULL DEFAULT 1 COMMENT '数据源类型',
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_dept` (`id`, `tenant_id`, `parent_id`, `ancestors`, `leader_id`, `dept_category`, `dept_name`, `full_name`, `sort`, `remark`, `status`, `is_deleted`) VALUES (1123598813738675201, '000000', 0, '0', NULL, 1, '布雷德科技', '上海布雷德科技有限公司', 1, NULL, 1, 0), (1123598813738675202, '000000', 1123598813738675201, '0,1123598813738675201', NULL, 1, '常州布雷德', '常州布雷德科技有限公司', 1, NULL, 1, 0), (1123598813738675203, '000000', 1123598813738675201, '0,1123598813738675201', NULL, 1, '苏州布雷德', '苏州布雷德科技有限公司', 1, NULL, 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_dict` (`id`, `parent_id`, `code`, `dict_key`, `dict_value`, `sort`, `remark`, `is_sealed`, `status`, `is_deleted`) VALUES (1123598814738675201, 0, 'sex', '-1', '性别', 1, NULL, 0, 1, 0), (1123598814738675202, 1123598814738675201, 'sex', '1', '男', 1, NULL, 0, 1, 0), (1123598814738675203, 1123598814738675201, 'sex', '2', '女', 2, NULL, 0, 1, 0), (1123598814738675204, 0, 'notice', '-1', '通知类型', 2, NULL, 0, 1, 0), (1123598814738675205, 1123598814738675204, 'notice', '1', '发布通知', 1, NULL, 0, 1, 0), (1123598814738675206, 1123598814738675204, 'notice', '2', '批转通知', 2, NULL, 0, 1, 0), (1123598814738675207, 1123598814738675204, 'notice', '3', '转发通知', 3, NULL, 0, 1, 0), (1123598814738675208, 1123598814738675204, 'notice', '4', '指示通知', 4, NULL, 0, 1, 0), (1123598814738675209, 1123598814738675204, 'notice', '5', '任免通知', 5, NULL, 0, 1, 0), (1123598814738675210, 1123598814738675204, 'notice', '6', '事务通知', 6, NULL, 0, 1, 0), (1123598814738675211, 0, 'menu_category', '-1', '菜单类型', 3, NULL, 0, 1, 0), (1123598814738675212, 1123598814738675211, 'menu_category', '1', '菜单', 1, NULL, 0, 1, 0), (1123598814738675213, 1123598814738675211, 'menu_category', '2', '按钮', 2, NULL, 0, 1, 0), (1123598814738675214, 0, 'button_func', '-1', '按钮功能', 4, NULL, 0, 1, 0), (1123598814738675215, 1123598814738675214, 'button_func', '1', '工具栏', 1, NULL, 0, 1, 0), (1123598814738675216, 1123598814738675214, 'button_func', '2', '操作栏', 2, NULL, 0, 1, 0), (1123598814738675217, 1123598814738675214, 'button_func', '3', '工具操作栏', 3, NULL, 0, 1, 0), (1123598814738675218, 0, 'yes_no', '-1', '是否', 5, NULL, 0, 1, 0), (1123598814738675219, 1123598814738675218, 'yes_no', '1', '否', 1, NULL, 0, 1, 0), (1123598814738675220, 1123598814738675218, 'yes_no', '2', '是', 2, NULL, 0, 1, 0), (1123598814738675221, 0, 'flow', '-1', '流程类型', 5, NULL, 0, 1, 0), (1123598814738675222, 1123598814738675221, 'flow', '1', '请假流程', 1, 'leave', 0, 1, 0), (1123598814738675223, 1123598814738675221, 'flow', '2', '报销流程', 2, 'expense', 0, 1, 0), (1123598814738675227, 0, 'org_category', '-1', '机构类型', 7, NULL, 0, 1, 0), (1123598814738675228, 1123598814738675227, 'org_category', '1', '公司', 1, NULL, 0, 1, 0), (1123598814738675229, 1123598814738675227, 'org_category', '2', '部门', 2, NULL, 0, 1, 0), (1123598814738675230, 1123598814738675227, 'org_category', '3', '小组', 3, NULL, 0, 1, 0), (1123598814738675231, 0, 'data_scope_type', '-1', '数据权限', 8, NULL, 0, 1, 0), (1123598814738675232, 1123598814738675231, 'data_scope_type', '1', '全部可见', 1, NULL, 0, 1, 0), (1123598814738675233, 1123598814738675231, 'data_scope_type', '2', '本人可见', 2, NULL, 0, 1, 0), (1123598814738675234, 1123598814738675231, 'data_scope_type', '3', '所在机构可见', 3, NULL, 0, 1, 0), (1123598814738675235, 1123598814738675231, 'data_scope_type', '4', '所在机构及子级可见', 4, NULL, 0, 1, 0), (1123598814738675236, 1123598814738675231, 'data_scope_type', '5', '自定义', 5, NULL, 0, 1, 0), (1123598814738675237, 0, 'api_scope_type', '-1', '接口权限', 10, NULL, 0, 1, 0), (1123598814738675238, 1123598814738675237, 'api_scope_type', '1', '系统接口', 1, NULL, 0, 1, 0), (1123598814738675239, 1123598814738675237, 'api_scope_type', '2', '业务接口', 2, NULL, 0, 1, 0), (1123598814738675240, 0, 'scope_category', '-1', '权限类型', 10, NULL, 0, 1, 0), (1123598814738675241, 1123598814738675240, 'scope_category', '1', '数据权限', 1, NULL, 0, 1, 0), (1123598814738675242, 1123598814738675240, 'scope_category', '2', '接口权限', 2, NULL, 0, 1, 0), (1123598814738676224, 0, 'oss', '-1', '对象存储类型', 6, NULL, 0, 1, 0), (1123598814738676225, 1123598814738676224, 'oss', '1', 'minio', 1, NULL, 0, 1, 0), (1123598814738676226, 1123598814738676224, 'oss', '2', '七牛云', 2, NULL, 0, 1, 0), (1123598814738676227, 1123598814738676224, 'oss', '3', '阿里云', 3, NULL, 0, 1, 0), (1123598814738676228, 1123598814738676224, 'oss', '4', '腾讯云', 4, NULL, 0, 1, 0), (1123598814738676229, 1123598814738676224, 'oss', '5', '华为云', 5, NULL, 0, 1, 0), (1123598814738676230, 1123598814738676224, 'oss', '6', 'amazon s3', 6, NULL, 0, 1, 0), (1123598814738676231, 1123598814738676224, 'oss', '7', '本地存储', 7, '', 0, 1, 0), (1123598814738677220, 0, 'sms', '-1', '短信服务类型', 11, NULL, 0, 1, 0), (1123598814738677221, 1123598814738677220, 'sms', '1', '云片', 1, NULL, 0, 1, 0), (1123598814738677222, 1123598814738677220, 'sms', '2', '七牛云', 2, NULL, 0, 1, 0), (1123598814738677223, 1123598814738677220, 'sms', '3', '阿里云', 3, NULL, 0, 1, 0), (1123598814738677224, 1123598814738677220, 'sms', '4', '腾讯云', 4, NULL, 0, 1, 0), (1123598814738777220, 0, 'post_category', '-1', '岗位类型', 12, NULL, 0, 1, 0), (1123598814738777221, 1123598814738777220, 'post_category', '1', '高层', 1, NULL, 0, 1, 0), (1123598814738777222, 1123598814738777220, 'post_category', '2', '中层', 2, NULL, 0, 1, 0), (1123598814738777223, 1123598814738777220, 'post_category', '3', '基层', 3, NULL, 0, 1, 0), (1123598814738777224, 1123598814738777220, 'post_category', '4', '其他', 4, NULL, 0, 1, 0), (1123598814738777230, 0, 'region', '-1', '行政区划', 13, NULL, 0, 1, 0), (1123598814738777231, 1123598814738777230, 'region', '0', '国家', 0, NULL, 0, 1, 0), (1123598814738777232, 1123598814738777230, 'region', '1', '省份/直辖市', 1, NULL, 0, 1, 0), (1123598814738777233, 1123598814738777230, 'region', '2', '地市', 2, NULL, 0, 1, 0), (1123598814738777234, 1123598814738777230, 'region', '3', '区县', 3, NULL, 0, 1, 0), (1123598814738777235, 1123598814738777230, 'region', '4', '乡镇', 4, NULL, 0, 1, 0), (1123598814738777236, 1123598814738777230, 'region', '5', '村委', 5, NULL, 0, 1, 0), (1123598814738778200, 0, 'user_type', '-1', '用户平台', 14, NULL, 0, 1, 0), (1123598814738778201, 1123598814738778200, 'user_type', '1', 'WEB', 1, NULL, 0, 1, 0), (1123598814738778202, 1123598814738778200, 'user_type', '2', 'APP', 2, NULL, 0, 1, 0), (1123598814738778203, 1123598814738778200, 'user_type', '3', 'OTHER', 3, NULL, 0, 1, 0), (1735215689272508418, 0, 'datasource_category', '-1', '数据源类型', 16, '', 0, 1, 0), (1735215870613241857, 1735215689272508418, 'datasource_category', '1', 'jdbc', 1, '', 0, 1, 0), (1735215901546233858, 1735215689272508418, 'datasource_category', '2', 'sharding', 2, '', 0, 1, 0);
COMMIT;
...
-- ----------------------------
DROP TABLE IF EXISTS `blade_job_info`;
CREATE TABLE `blade_job_info`  (
  `id` bigint NOT NULL COMMENT '主键',
  `job_server_id` bigint NULL DEFAULT NULL COMMENT '任务服务ID',
  `job_id` bigint NULL DEFAULT NULL COMMENT '任务 ID，可选，null 代表创建任务，否则填写需要修改的任务 ID',
  ...
  `time_expression_type` int NULL DEFAULT NULL COMMENT '时间表达式类型，枚举值',
  ...
  `execute_type` int NULL DEFAULT NULL COMMENT '执行类型，枚举值',
  `processor_type` int NULL DEFAULT NULL COMMENT '处理器类型，枚举值',
  ...
  `max_instance_num` int NULL DEFAULT NULL COMMENT '最大实例数，该任务同时执行的数量（任务和实例就像是类和对象的关系，任务被调度执行后被称为实例）',
  `concurrency` int NULL DEFAULT NULL COMMENT '单机线程并发数，表示该实例执行过程中每个Worker 使用的线程数量',
  `instance_time_limit` bigint NULL DEFAULT NULL COMMENT '任务实例运行时间限制，0 代表无任何限制，超时会被打断并判定为执行失败',
  `instance_retry_num` int NULL DEFAULT NULL COMMENT 'instanceRetryNum	任务实例重试次数，整个任务失败时重试，代价大，不推荐使用',
  `task_retry_num` int NULL DEFAULT NULL COMMENT 'taskRetryNum	Task 重试次数，每个子 Task 失败后单独重试，代价小，推荐使用',
  ...
  `max_worker_count` int NULL DEFAULT NULL COMMENT '最大执行机器数量，限定调动执行的机器数量，0代表无限制',
  `notify_user_ids` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接收报警的用户 ID 列表',
  `enable` int NULL DEFAULT NULL COMMENT '是否启用该任务，未启用的任务不会被调度',
  `dispatch_strategy` int NULL DEFAULT NULL COMMENT '调度策略，枚举，目前支持随机（RANDOM）和 健康度优先（HEALTH_FIRST）',
  ...
  `alert_threshold` int NULL DEFAULT NULL COMMENT '错误阈值，0代表不限制',
  `statistic_window_len` int NULL DEFAULT NULL COMMENT '统计的窗口长度(s)，0代表不限制',
  `silence_window_len` int NULL DEFAULT NULL COMMENT '沉默时间窗口(s)，0代表不限制',
  `log_type` int NULL DEFAULT NULL COMMENT '日志配置',
  `log_level` int NULL DEFAULT NULL COMMENT '日志级别',
  ...
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '日志信息表';
...
-- ----------------------------
DROP TABLE IF EXISTS `blade_job_server`;
CREATE TABLE `blade_job_server`  (
  `id` bigint NOT NULL COMMENT '主键',
  `job_server_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务服务名称',
  `job_server_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务服务器地址',
  `job_app_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务应用名称',
  `job_app_password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务应用密码',
  `job_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务备注',
  `create_user` bigint NULL DEFAULT NULL COMMENT '创建人',
  `create_dept` bigint NULL DEFAULT NULL COMMENT '创建部门',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` bigint NULL DEFAULT NULL COMMENT '修改人',
  ...
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '任务服务表';
...
CREATE TABLE `blade_log_error`  (
  ...
  `line_number` int NULL DEFAULT NULL COMMENT '错误行数',
  `remote_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作IP地址',
  `method_class` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '方法类',
...
CREATE TABLE `blade_model`  (
  `id` bigint NOT NULL COMMENT '主键',
  `datasource_id` bigint NULL DEFAULT NULL COMMENT '数据源主键',
  ...
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据模型表';
...
CREATE TABLE `blade_model_prototype`  (
  `id` bigint NOT NULL COMMENT '主键',
  `model_id` bigint NULL DEFAULT NULL COMMENT '模型主键',
  ...
  `is_list` int NULL DEFAULT NULL COMMENT '列表显示',
  `is_form` int NULL DEFAULT NULL COMMENT '表单显示',
  `is_row` int NULL DEFAULT NULL COMMENT '独占一行',
  ...
  `is_required` int NULL DEFAULT NULL COMMENT '是否必填',
  `is_query` int NULL DEFAULT NULL COMMENT '查询配置',
  `query_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '查询配置',
  `create_user` bigint NULL DEFAULT NULL COMMENT '创建人',
  `create_dept` bigint NULL DEFAULT NULL COMMENT '创建部门',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` bigint NULL DEFAULT NULL COMMENT '修改人',
  ...
  `is_deleted` int NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据原型表';
...
CREATE TABLE `blade_oss`  (
  ...
  `transform_endpoint` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '外网资源地址',
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_oss` (`id`, `tenant_id`, `category`, `oss_code`, `endpoint`, `transform_endpoint`, `access_key`, `secret_key`, `bucket_name`, `app_id`, `region`, `remark`, `create_user`, `create_dept`, `create_time`, `update_user`, `update_time`, `status`, `is_deleted`) VALUES (1132486733992468482, '000000', 1, 'minio', 'http://127.0.0.1:9000', '', 'D99KGE6ZTQXSATTJWU24', 'QyVqGnhIQQE734UYSUFlGOZViE6+ZlDEfUG3NjhJ', 'bladex', '', '', '', 1123598821738675201, 1123598813738675201, '2019-05-26 11:20:52', 1123598821738675201, '2019-05-27 08:34:55', 2, 0), (1132487155981393922, '000000', 2, 'qiniu', 'http://ps458elcs.bkt.clouddn.com', '', 'N_Loh1ngBqcJovwiAJqR91Ifj2vgOWHOf8AwBA_h', 'AuzuA1KHAbkIndCU0dB3Zfii2O3crHNODDmpxHRS', 'bladex', '', '', '', 1123598821738675201, 1123598813738675201, '2019-05-26 11:22:33', 1123598821738675201, '2019-05-26 23:27:56', 1, 0);
COMMIT;
...
-- ----------------------------
DROP TABLE IF EXISTS `blade_record_data`;
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_role` (`id`, `tenant_id`, `parent_id`, `role_name`, `sort`, `role_alias`, `status`, `is_deleted`) VALUES (1123598816738675201, '000000', 0, '超级管理员', 1, 'administrator', 1, 0), (1123598816738675202, '000000', 0, '用户', 2, 'user', 1, 0), (1123598816738675203, '000000', 1123598816738675202, '人事', 1, 'hr', 1, 0), (1123598816738675204, '000000', 1123598816738675202, '经理', 2, 'manager', 1, 0), (1123598816738675205, '000000', 1123598816738675202, '老板', 3, 'boss', 1, 0);
COMMIT;
...
CREATE TABLE `blade_tenant`  (
  ...
  `domain_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '域名地址',
  ...
  `package_id` bigint NULL DEFAULT NULL COMMENT '产品包ID',
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_tenant` (`id`, `tenant_id`, `tenant_name`, `domain_url`, `background_url`, `linkman`, `contact_number`, `address`, `account_number`, `expire_time`, `package_id`, `datasource_id`, `license_key`, `create_user`, `create_dept`, `create_time`, `update_user`, `update_time`, `status`, `is_deleted`) VALUES (1123598820738675201, '000000', '管理组', NULL, NULL, 'admin', '666666', '管理组', -1, NULL, NULL, NULL, NULL, 1123598821738675201, 1123598813738675201, '2019-01-01 00:00:39', 1123598821738675201, '2019-01-01 00:00:39', 1, 0);
COMMIT;

-- ----------------------------
-- Table structure for blade_tenant_datasource
-- ----------------------------
DROP TABLE IF EXISTS `blade_tenant_datasource`;
CREATE TABLE `blade_tenant_datasource`  (
  `id` bigint NOT NULL COMMENT '主键',
  `category` int NULL DEFAULT 1 COMMENT '数据源类型',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `driver_class` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '驱动类',
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_tenant_datasource` (`id`, `category`, `name`, `driver_class`, `url`, `username`, `password`, `sharding_config`, `remark`, `create_user`, `create_dept`, `create_time`, `update_user`, `update_time`, `status`, `is_deleted`) VALUES (1161483357481541634, 1, 'mysql', 'com.mysql.cj.jdbc.Driver', 'jdbc:mysql://localhost:3306/bladex?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&serverTimezone=GMT%2B8&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', 'root', 'root', NULL, 'mysql', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:06', 1123598821738675201, '2020-08-08 12:20:06', 1, 0), (1161483504353484802, 1, 'postgresql', 'org.postgresql.Driver', 'jdbc:postgresql://127.0.0.1:5432/bladex', 'postgres', '123456', NULL, 'postgresql', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:02', 1123598821738675201, '2020-08-08 12:20:02', 1, 0), (1161483594023510018, 1, 'oracle', 'oracle.jdbc.OracleDriver', 'jdbc:oracle:thin:@127.0.0.1:1521:orcl', 'BLADEX', 'BLADEX', NULL, 'oracle', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:03', 1123598821738675201, '2020-08-08 12:20:03', 1, 0), (1161483594023510020, 1, 'sqlserver', 'com.microsoft.sqlserver.jdbc.SQLServerDriver', 'jdbc:sqlserver://127.0.0.1:1433;DatabaseName=bladex', 'bladex', 'bladex', NULL, 'sqlserver', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:03', 1123598821738675201, '2020-08-08 12:20:03', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_user` (`id`, `tenant_id`, `code`, `user_type`, `account`, `password`, `name`, `real_name`, `avatar`, `email`, `phone`, `birthday`, `sex`, `role_id`, `dept_id`, `post_id`, `leader_id`, `is_leader`, `create_user`, `create_dept`, `create_time`, `update_user`, `update_time`, `status`, `is_deleted`) VALUES (1123598821738675201, '000000', NULL, 1, 'admin', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', '管理员', '管理员', 'https://bladex.cn/images/logo-small.png', 'admin@bladex.vip', '', '2018-08-08 00:00:00', 1, '1123598816738675201', '1123598813738675201', '1123598817738675201', NULL, 0, 1123598821738675201, 1123598813738675201, '2018-08-08 00:00:00', 1123598821738675201, '2018-08-08 00:00:00', 1, 0), (1123598821738675202, '000000', NULL, 1, 'hr', '5e79b90f7bba52d54115f086e48f539016a27ec6', '人事', '人事', '', 'hr@bladex.vip', '', '2018-08-08 00:00:00', 1, '1123598816738675203', '1123598813738675202', '1123598817738675207', NULL, 0, 1123598821738675201, 1123598813738675201, '2019-04-27 17:03:10', 1123598821738675201, '2019-04-27 17:03:10', 1, 0), (1123598821738675203, '000000', NULL, 1, 'manager', 'dfbaa3b61caa3a319f463cc165085aa8c822d2ce', '经理', '经理', '', 'manager@bladex.vip', '', '2018-08-08 00:00:00', 1, '1123598816738675204', '1123598813738675202', '1123598817738675206', NULL, 0, 1123598821738675201, 1123598813738675201, '2019-04-27 17:03:38', 1123598821738675201, '2019-04-27 17:03:38', 1, 0), (1123598821738675204, '000000', NULL, 1, 'boss', 'abe57d23e18f7ad8ea99c86e430c90a05119a9d3', '老板', '老板', '', 'boss@bladex.vip', '', '2018-08-08 00:00:00', 1, '1123598816738675205', '1123598813738675202', '1123598817738675201', NULL, 0, 1123598821738675201, 1123598813738675201, '2019-04-27 17:03:55', 1123598821738675201, '2019-04-27 17:03:55', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blade_user_dept` (`id`, `user_id`, `dept_id`, `status`, `is_deleted`) VALUES (1203503640757788674, 1123598821738675201, 1123598813738675201, 1, 0), (1203503653323923458, 1123598821738675202, 1123598813738675202, 1, 0), (1203503663402835969, 1123598821738675203, 1123598813738675202, 1, 0), (1203503672911323137, 1123598821738675204, 1123598813738675202, 1, 0);
COMMIT;
