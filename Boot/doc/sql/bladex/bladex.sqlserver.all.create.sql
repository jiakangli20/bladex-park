/*
 ...
 Source Server Version : 15004390 (15.00.4390)
 Source Host           : 127.0.0.1:1433
 Source Catalog        : bladex
 Source Schema         : dbo

 Target Server Type    : SQL Server
 Target Server Version : 15004390 (15.00.4390)
 File Encoding         : 65001

 Date: 01/01/2026 19:01:01
*/
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_api_key]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_api_key]
GO

CREATE TABLE [dbo].[blade_api_key] (
  [id] bigint  NOT NULL,
  [tenant_id] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '000000' NULL,
  [user_id] bigint  NOT NULL,
  [name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [api_key] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [api_path] nvarchar(max) COLLATE Chinese_PRC_CI_AS  NULL,
  [expire_time] datetime2(0)  NULL,
  [ext_params] nvarchar(max) COLLATE Chinese_PRC_CI_AS  NULL,
...
ALTER TABLE [dbo].[blade_api_key] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_api_key_log]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_api_key_log]
GO

CREATE TABLE [dbo].[blade_api_key_log] (
  [id] bigint  NOT NULL,
  [tenant_id] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '000000' NULL,
...
ALTER TABLE [dbo].[blade_api_key_log] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_auth_lock]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_auth_lock]
GO

CREATE TABLE [dbo].[blade_auth_lock] (
  [id] bigint  NOT NULL,
  [user_id] bigint  NULL,
  [tenant_id] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '000000' NULL,
  [lock_type] nvarchar(20) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [lock_status] nvarchar(20) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [lock_target] nvarchar(100) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [remote_ip] nvarchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [user_agent] nvarchar(500) COLLATE Chinese_PRC_CI_AS  NULL,
  [fail_count] int DEFAULT 0 NULL,
  [lock_begin_time] datetime2(0)  NOT NULL,
  [lock_end_time] datetime2(0)  NULL,
  [lock_reason] nvarchar(500) COLLATE Chinese_PRC_CI_AS  NULL,
  [unlock_reason] nvarchar(500) COLLATE Chinese_PRC_CI_AS  NULL,
  [status] int DEFAULT 1 NOT NULL,
  [is_deleted] int DEFAULT 0 NOT NULL
)
GO

ALTER TABLE [dbo].[blade_auth_lock] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_auth_log]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_auth_log]
GO

CREATE TABLE [dbo].[blade_auth_log] (
  [id] bigint  NOT NULL,
  [user_id] bigint  NULL,
  [tenant_id] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '000000' NULL,
  [service_id] nvarchar(32) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [real_name] nvarchar(20) COLLATE Chinese_PRC_CI_AS  NULL,
  [grant_type] nvarchar(30) COLLATE Chinese_PRC_CI_AS  NULL,
  [remote_ip] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [user_agent] nvarchar(1000) COLLATE Chinese_PRC_CI_AS  NULL,
...
ALTER TABLE [dbo].[blade_auth_log] SET (LOCK_ESCALATION = TABLE)
GO
...
INSERT INTO [dbo].[blade_client] ([id], [client_id], [client_secret], [resource_ids], [scope], [authorized_grant_types], [web_server_redirect_uri], [authorities], [access_token_validity], [refresh_token_validity], [additional_information], [autoapprove], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1123598811738675201', N'sword', N'sword_secret', NULL, N'all', N'authorization_code,password,refresh_token,captcha,social,sms_code,register', N'http://localhost:8888', NULL, N'3600', N'604800', NULL, NULL, N'1123598815738675201', N'1123598813738675201', N'2019-03-24 10:40:55', N'1123598815738675201', N'2019-03-24 10:40:59', N'1', N'0'), (N'1123598811738675202', N'saber', N'saber_secret', NULL, N'all', N'authorization_code,password,refresh_token,captcha,social,sms_code,register', N'http://localhost:1888', NULL, N'3600', N'604800', NULL, NULL, N'1123598815738675201', N'1123598813738675201', N'2019-03-24 10:42:29', N'1123598815738675201', N'2019-03-24 10:42:32', N'1', N'0'), (N'1123598811738675203', N'saber3', N'saber3_secret', NULL, N'all', N'authorization_code,password,refresh_token,captcha,social,sms_code,register', N'http://localhost:2888/login', NULL, N'3600', N'604800', NULL, NULL, N'1123598815738675201', N'1123598813738675201', N'2024-04-01 00:00:00', N'1123598815738675201', N'2024-04-01 00:00:00', N'1', N'0'), (N'1123598811738675204', N'rider', N'rider_secret', NULL, N'all', N'authorization_code,password,refresh_token,captcha,social,sms_code,register', N'http://localhost:88', NULL, N'3600', N'604800', NULL, NULL, N'1123598815738675201', N'1123598813738675201', N'2024-04-01 00:00:00', N'1123598815738675201', N'2024-04-01 00:00:00', N'1', N'0')
GO
...
-- ----------------------------
-- Table structure for blade_code_setting
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_code_setting]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_code_setting]
GO

CREATE TABLE [dbo].[blade_code_setting] (
  [id] bigint  NOT NULL,
...
ALTER TABLE [dbo].[blade_code_setting] SET (LOCK_ESCALATION = TABLE)
GO
...
CREATE TABLE [dbo].[blade_datasource] (
  ...
  [sharding_config] nvarchar(max) COLLATE Chinese_PRC_CI_AS  NULL,
...
CREATE TABLE [dbo].[blade_dept] (
  ...
  [leader_id] nvarchar(1000) COLLATE Chinese_PRC_CI_AS  NULL,
...
INSERT INTO [dbo].[blade_dept] ([id], [tenant_id], [parent_id], [ancestors], [leader_id], [dept_category], [dept_name], [full_name], [sort], [remark], [status], [is_deleted]) VALUES (N'1123598813738675201', N'000000', N'0', N'0', N'', N'1', N'布雷德科技', N'上海布雷德科技有限公司', N'1', NULL, N'1', N'0'), (N'1123598813738675202', N'000000', N'1123598813738675201', N'0,1123598813738675201', N'', N'1', N'常州布雷德', N'常州布雷德科技有限公司', N'1', NULL, N'1', N'0'), (N'1123598813738675203', N'000000', N'1123598813738675201', N'0,1123598813738675201', N'', N'1', N'苏州布雷德', N'苏州布雷德科技有限公司', N'1', NULL, N'1', N'0')
GO
...
INSERT INTO [dbo].[blade_dict] ([id], [parent_id], [code], [dict_key], [dict_value], [sort], [remark], [is_sealed], [status], [is_deleted]) VALUES (N'1123598814738675201', N'0', N'sex', N'-1', N'性别', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675202', N'1123598814738675201', N'sex', N'1', N'男', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675203', N'1123598814738675201', N'sex', N'2', N'女', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675204', N'0', N'notice', N'-1', N'通知类型', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675205', N'1123598814738675204', N'notice', N'1', N'发布通知', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675206', N'1123598814738675204', N'notice', N'2', N'批转通知', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675207', N'1123598814738675204', N'notice', N'3', N'转发通知', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738675208', N'1123598814738675204', N'notice', N'4', N'指示通知', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738675209', N'1123598814738675204', N'notice', N'5', N'任免通知', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738675210', N'1123598814738675204', N'notice', N'6', N'事务通知', N'6', NULL, N'0', N'1', N'0'), (N'1123598814738675211', N'0', N'menu_category', N'-1', N'菜单类型', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738675212', N'1123598814738675211', N'menu_category', N'1', N'菜单', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675213', N'1123598814738675211', N'menu_category', N'2', N'按钮', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675214', N'0', N'button_func', N'-1', N'按钮功能', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738675215', N'1123598814738675214', N'button_func', N'1', N'工具栏', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675216', N'1123598814738675214', N'button_func', N'2', N'操作栏', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675217', N'1123598814738675214', N'button_func', N'3', N'工具操作栏', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738675218', N'0', N'yes_no', N'-1', N'是否', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738675219', N'1123598814738675218', N'yes_no', N'1', N'否', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675220', N'1123598814738675218', N'yes_no', N'2', N'是', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675221', N'0', N'flow', N'-1', N'流程类型', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738675222', N'1123598814738675221', N'flow', N'1', N'请假流程', N'1', N'leave', N'0', N'1', N'0'), (N'1123598814738675223', N'1123598814738675221', N'flow', N'2', N'报销流程', N'2', N'expense', N'0', N'1', N'0'), (N'1123598814738675227', N'0', N'org_category', N'-1', N'机构类型', N'7', NULL, N'0', N'1', N'0'), (N'1123598814738675228', N'1123598814738675227', N'org_category', N'1', N'公司', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675229', N'1123598814738675227', N'org_category', N'2', N'部门', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675230', N'1123598814738675227', N'org_category', N'3', N'小组', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738675231', N'0', N'data_scope_type', N'-1', N'数据权限', N'8', NULL, N'0', N'1', N'0'), (N'1123598814738675232', N'1123598814738675231', N'data_scope_type', N'1', N'全部可见', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675233', N'1123598814738675231', N'data_scope_type', N'2', N'本人可见', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675234', N'1123598814738675231', N'data_scope_type', N'3', N'所在机构可见', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738675235', N'1123598814738675231', N'data_scope_type', N'4', N'所在机构及子级可见', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738675236', N'1123598814738675231', N'data_scope_type', N'5', N'自定义', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738675237', N'0', N'api_scope_type', N'-1', N'接口权限', N'10', NULL, N'0', N'1', N'0'), (N'1123598814738675238', N'1123598814738675237', N'api_scope_type', N'1', N'系统接口', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675239', N'1123598814738675237', N'api_scope_type', N'2', N'业务接口', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738675240', N'0', N'scope_category', N'-1', N'权限类型', N'10', NULL, N'0', N'1', N'0'), (N'1123598814738675241', N'1123598814738675240', N'scope_category', N'1', N'数据权限', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738675242', N'1123598814738675240', N'scope_category', N'2', N'接口权限', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738676224', N'0', N'oss', N'-1', N'对象存储类型', N'6', NULL, N'0', N'1', N'0'), (N'1123598814738676225', N'1123598814738676224', N'oss', N'1', N'minio', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738676226', N'1123598814738676224', N'oss', N'2', N'七牛云', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738676227', N'1123598814738676224', N'oss', N'3', N'阿里云', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738676228', N'1123598814738676224', N'oss', N'4', N'腾讯云', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738676229', N'1123598814738676224', N'oss', N'5', N'华为云', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738676230', N'1123598814738676224', N'oss', N'6', N'amazon s3', N'6', NULL, N'0', N'1', N'0'), (N'1123598814738676231', N'1123598814738676224', N'oss', N'7', N'本地存储', N'7', N'', N'0', N'1', N'0'), (N'1123598814738677220', N'0', N'sms', N'-1', N'短信服务类型', N'11', NULL, N'0', N'1', N'0'), (N'1123598814738677221', N'1123598814738677220', N'sms', N'1', N'云片', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738677222', N'1123598814738677220', N'sms', N'2', N'七牛云', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738677223', N'1123598814738677220', N'sms', N'3', N'阿里云', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738677224', N'1123598814738677220', N'sms', N'4', N'腾讯云', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738777220', N'0', N'post_category', N'-1', N'岗位类型', N'12', NULL, N'0', N'1', N'0'), (N'1123598814738777221', N'1123598814738777220', N'post_category', N'1', N'高层', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738777222', N'1123598814738777220', N'post_category', N'2', N'中层', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738777223', N'1123598814738777220', N'post_category', N'3', N'基层', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738777224', N'1123598814738777220', N'post_category', N'4', N'其他', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738777230', N'0', N'region', N'-1', N'行政区划', N'13', NULL, N'0', N'1', N'0'), (N'1123598814738777231', N'1123598814738777230', N'region', N'0', N'国家', N'0', NULL, N'0', N'1', N'0'), (N'1123598814738777232', N'1123598814738777230', N'region', N'1', N'省份/直辖市', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738777233', N'1123598814738777230', N'region', N'2', N'地市', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738777234', N'1123598814738777230', N'region', N'3', N'区县', N'3', NULL, N'0', N'1', N'0'), (N'1123598814738777235', N'1123598814738777230', N'region', N'4', N'乡镇', N'4', NULL, N'0', N'1', N'0'), (N'1123598814738777236', N'1123598814738777230', N'region', N'5', N'村委', N'5', NULL, N'0', N'1', N'0'), (N'1123598814738778200', N'0', N'user_type', N'-1', N'用户平台', N'14', NULL, N'0', N'1', N'0'), (N'1123598814738778201', N'1123598814738778200', N'user_type', N'1', N'WEB', N'1', NULL, N'0', N'1', N'0'), (N'1123598814738778202', N'1123598814738778200', N'user_type', N'2', N'APP', N'2', NULL, N'0', N'1', N'0'), (N'1123598814738778203', N'1123598814738778200', N'user_type', N'3', N'OTHER', N'3', NULL, N'0', N'1', N'0'), (N'1735215689272508418', N'0', N'datasource_category', N'-1', N'数据源类型', N'16', N'', N'0', N'1', N'0'), (N'1735215870613241857', N'1735215689272508418', N'datasource_category', N'1', N'jdbc', N'1', N'', N'0', N'1', N'0'), (N'1735215901546233858', N'1735215689272508418', N'datasource_category', N'2', N'sharding', N'2', N'', N'0', N'1', N'0')
GO
...
-- ----------------------------
-- Table structure for blade_job_info
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_job_info]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_job_info]
GO
...
CREATE TABLE [dbo].[blade_job_info] (
  ...
  [job_id] bigint  NULL,
  [job_name] nvarchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_description] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_params] nvarchar(max) COLLATE Chinese_PRC_CI_AS  NULL,
  [time_expression_type] int  NULL,
  [time_expression] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [execute_type] int  NULL,
  [processor_type] int  NULL,
  [processor_info] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [designated_workers] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [max_worker_count] int  NULL,
  [notify_user_ids] nvarchar(2000) COLLATE Chinese_PRC_CI_AS  NULL,
  [enable] int  NULL,
  [dispatch_strategy] int  NULL,
  [lifecycle] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [alert_threshold] int  NULL,
  [statistic_window_len] int  NULL,
  [silence_window_len] int  NULL,
  [log_type] int  NULL,
  [log_level] int  NULL,
  [extra] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [create_user] bigint  NULL,
  [create_dept] bigint  NULL,
  [create_time] datetime2(0)  NULL,
  [update_user] bigint  NULL,
...
ALTER TABLE [dbo].[blade_job_info] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Table structure for blade_job_server
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_job_server]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_job_server]
GO

CREATE TABLE [dbo].[blade_job_server] (
  [id] bigint  NOT NULL,
  [job_server_name] nvarchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_server_url] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_app_name] nvarchar(20) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_app_password] nvarchar(100) COLLATE Chinese_PRC_CI_AS  NULL,
  [job_remark] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [create_user] bigint  NULL,
  [create_dept] bigint  NULL,
  [create_time] datetime2(0)  NULL,
  [update_user] bigint  NULL,
...
ALTER TABLE [dbo].[blade_job_server] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Records of blade_job_server
-- ----------------------------
BEGIN TRANSACTION
GO

INSERT INTO [dbo].[blade_job_server] ([id], [job_server_name], [job_server_url], [job_app_name], [job_app_password], [job_remark], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1741512022505590785', N'任务调度服务器', N'127.0.0.1:7700', N'blade-job', N'blade-job', N'基础服务', N'1123598821738675201', N'1123598813738675201', N'2024-01-01 01:29:57', N'1123598821738675201', N'2024-01-01 01:29:57', N'1', N'0')
GO
...
-- ----------------------------
-- Records of blade_model_prototype
-- ----------------------------
BEGIN TRANSACTION
GO
...
CREATE TABLE [dbo].[blade_oss] (
  ...
  [transform_endpoint] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
...
INSERT INTO [dbo].[blade_oss] ([id], [tenant_id], [category], [oss_code], [endpoint], [transform_endpoint], [access_key], [secret_key], [bucket_name], [app_id], [region], [remark], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1132486733992468482', N'000000', N'1', N'minio', N'http://127.0.0.1:9000', N'', N'D99KGE6ZTQXSATTJWU24', N'QyVqGnhIQQE734UYSUFlGOZViE6+ZlDEfUG3NjhJ', N'bladex', N'', N'', N'', N'1123598821738675201', N'1123598813738675201', N'2019-05-26 11:20:52', N'1123598821738675201', N'2019-05-27 08:34:55', N'2', N'0'), (N'1132487155981393922', N'000000', N'2', N'qiniu', N'http://ps458elcs.bkt.clouddn.com', N'', N'N_Loh1ngBqcJovwiAJqR91Ifj2vgOWHOf8AwBA_h', N'AuzuA1KHAbkIndCU0dB3Zfii2O3crHNODDmpxHRS', N'bladex', N'', N'', N'', N'1123598821738675201', N'1123598813738675201', N'2019-05-26 11:22:33', N'1123598821738675201', N'2019-05-26 23:27:56', N'1', N'0')
GO
...
-- ----------------------------
-- Table structure for blade_record_data
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_record_data]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_record_data]
GO

CREATE TABLE [dbo].[blade_record_data] (
  [id] bigint  NOT NULL,
  [tenant_id] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '000000' NULL,
  [service_id] nvarchar(32) COLLATE Chinese_PRC_CI_AS  NULL,
  [server_host] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [server_ip] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [env] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [record_level] nvarchar(12) COLLATE Chinese_PRC_CI_AS DEFAULT '' NULL,
  [method] nvarchar(10) COLLATE Chinese_PRC_CI_AS  NULL,
  [request_uri] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [user_agent] nvarchar(1000) COLLATE Chinese_PRC_CI_AS  NULL,
  [remote_ip] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [operation] nvarchar(255) COLLATE Chinese_PRC_CI_AS DEFAULT '' NULL,
  [table_name] nvarchar(255) COLLATE Chinese_PRC_CI_AS DEFAULT '' NULL,
  [old_data] text COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [new_data] text COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [record_message] text COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [record_result] text COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [record_cost] nvarchar(64) COLLATE Chinese_PRC_CI_AS  NULL,
...
ALTER TABLE [dbo].[blade_record_data] SET (LOCK_ESCALATION = TABLE)
GO
...
CREATE TABLE [dbo].[blade_region] (
  ...
  [province_name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NULL,
  [city_code] nvarchar(12) COLLATE Chinese_PRC_CI_AS  NULL,
  [city_name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NULL,
  [district_code] nvarchar(12) COLLATE Chinese_PRC_CI_AS  NULL,
  [district_name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NULL,
  [town_code] nvarchar(12) COLLATE Chinese_PRC_CI_AS  NULL,
  [town_name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NULL,
  [village_code] nvarchar(12) COLLATE Chinese_PRC_CI_AS  NULL,
  [village_name] nvarchar(128) COLLATE Chinese_PRC_CI_AS  NULL,
...
INSERT INTO [dbo].[blade_report_file] ([id], [name], [content], [create_time], [update_time], [is_deleted]) VALUES (N'1291962038049910785', N'notice.ureport.xml', , N'2020-08-08 12:58:48', N'2020-08-08 12:58:48', N'0')
GO
...
INSERT INTO [dbo].[blade_role] ([id], [tenant_id], [parent_id], [role_name], [sort], [role_alias], [status], [is_deleted]) VALUES (N'1123598816738675201', N'000000', N'0', N'超级管理员', N'1', N'administrator', N'1', N'0'), (N'1123598816738675202', N'000000', N'0', N'用户', N'2', N'user', N'1', N'0'), (N'1123598816738675203', N'000000', N'1123598816738675202', N'人事', N'1', N'hr', N'1', N'0'), (N'1123598816738675204', N'000000', N'1123598816738675202', N'经理', N'2', N'manager', N'1', N'0'), (N'1123598816738675205', N'000000', N'1123598816738675202', N'老板', N'3', N'boss', N'1', N'0')
GO
...
INSERT INTO [dbo].[blade_tenant] ([id], [tenant_id], [tenant_name], [domain_url], [background_url], [linkman], [contact_number], [address], [account_number], [expire_time], [package_id], [datasource_id], [license_key], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1123598820738675201', N'000000', N'管理组', NULL, NULL, N'admin', N'666666', N'管理组', N'-1', NULL, NULL, NULL, NULL, N'1123598821738675201', N'1123598813738675201', N'2019-01-01 00:00:39', N'1123598821738675201', N'2019-01-01 00:00:39', N'1', N'0')
GO
...
-- ----------------------------
-- Table structure for blade_tenant_datasource
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[blade_tenant_datasource]') AND type IN ('U'))
	DROP TABLE [dbo].[blade_tenant_datasource]
GO

CREATE TABLE [dbo].[blade_tenant_datasource] (
  [id] bigint  NOT NULL,
  [category] int  NULL,
  [name] nvarchar(100) COLLATE Chinese_PRC_CI_AS  NULL,
  [driver_class] nvarchar(100) COLLATE Chinese_PRC_CI_AS  NULL,
...
ALTER TABLE [dbo].[blade_tenant_datasource] SET (LOCK_ESCALATION = TABLE)
GO

EXEC sp_addextendedproperty
'MS_Description', N'主键',
'SCHEMA', N'dbo',
'TABLE', N'blade_tenant_datasource',
'COLUMN', N'id'
GO
...
-- ----------------------------
-- Records of blade_tenant_datasource
-- ----------------------------
BEGIN TRANSACTION
GO

INSERT INTO [dbo].[blade_tenant_datasource] ([id], [category], [name], [driver_class], [url], [username], [password], [sharding_config], [remark], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1161483357481541634', N'1', N'mysql', N'com.mysql.cj.jdbc.Driver', N'jdbc:mysql://localhost:3306/bladex?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&serverTimezone=GMT%2B8&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', N'root', N'root', N'', N'mysql', N'1123598821738675201', N'1123598813738675201', N'2020-08-08 12:20:06', N'1123598821738675201', N'2020-08-08 12:20:06', N'1', N'0'), (N'1161483504353484802', N'1', N'postgresql', N'org.postgresql.Driver', N'jdbc:postgresql://127.0.0.1:5432/bladex', N'postgres', N'123456', N'', N'postgresql', N'1123598821738675201', N'1123598813738675201', N'2020-08-08 12:20:02', N'1123598821738675201', N'2020-08-08 12:20:02', N'1', N'0'), (N'1161483594023510018', N'1', N'oracle', N'oracle.jdbc.OracleDriver', N'jdbc:oracle:thin:@127.0.0.1:1521:orcl', N'BLADEX', N'BLADEX', N'', N'oracle', N'1123598821738675201', N'1123598813738675201', N'2020-08-08 12:20:03', N'1123598821738675201', N'2020-08-08 12:20:03', N'1', N'0'), (N'1161483594023510020', N'1', N'sqlserver', N'com.microsoft.sqlserver.jdbc.SQLServerDriver', N'jdbc:sqlserver://127.0.0.1:1433;DatabaseName=bladex', N'bladex', N'bladex', N'', N'sqlserver', N'1123598821738675201', N'1123598813738675201', N'2020-08-08 12:20:03', N'1123598821738675201', N'2020-08-08 12:20:03', N'1', N'0')
GO
...
-- ----------------------------
-- Records of blade_tenant_package
-- ----------------------------
BEGIN TRANSACTION
GO
...
INSERT INTO [dbo].[blade_user] ([id], [tenant_id], [code], [user_type], [account], [password], [name], [real_name], [avatar], [email], [phone], [birthday], [sex], [role_id], [dept_id], [post_id], [leader_id], [is_leader], [create_user], [create_dept], [create_time], [update_user], [update_time], [status], [is_deleted]) VALUES (N'1123598821738675201', N'000000', NULL, N'1', N'admin', N'90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', N'管理员', N'管理员', N'https://bladex.cn/images/logo-small.png', N'admin@bladex.vip', N'', N'2018-08-08 00:00:00', N'1', N'1123598816738675201', N'1123598813738675201', N'1123598817738675201', N'', N'0', N'1123598821738675201', N'1123598813738675201', N'2018-08-08 00:00:00', N'1123598821738675201', N'2018-08-08 00:00:00', N'1', N'0'), (N'1123598821738675202', N'000000', NULL, N'1', N'hr', N'5e79b90f7bba52d54115f086e48f539016a27ec6', N'人事', N'人事', N'', N'hr@bladex.vip', N'', N'2018-08-08 00:00:00', N'1', N'1123598816738675203', N'1123598813738675202', N'1123598817738675207', N'', N'0', N'1123598821738675201', N'1123598813738675201', N'2019-04-27 17:03:10', N'1123598821738675201', N'2019-04-27 17:03:10', N'1', N'0'), (N'1123598821738675203', N'000000', NULL, N'1', N'manager', N'dfbaa3b61caa3a319f463cc165085aa8c822d2ce', N'经理', N'经理', N'', N'manager@bladex.vip', N'', N'2018-08-08 00:00:00', N'1', N'1123598816738675204', N'1123598813738675202', N'1123598817738675206', N'', N'0', N'1123598821738675201', N'1123598813738675201', N'2019-04-27 17:03:38', N'1123598821738675201', N'2019-04-27 17:03:38', N'1', N'0'), (N'1123598821738675204', N'000000', NULL, N'1', N'boss', N'abe57d23e18f7ad8ea99c86e430c90a05119a9d3', N'老板', N'老板', N'', N'boss@bladex.vip', N'', N'2018-08-08 00:00:00', N'1', N'1123598816738675205', N'1123598813738675202', N'1123598817738675201', N'', N'0', N'1123598821738675201', N'1123598813738675201', N'2019-04-27 17:03:55', N'1123598821738675201', N'2019-04-27 17:03:55', N'1', N'0')
GO
...
INSERT INTO [dbo].[blade_user_dept] ([id], [user_id], [dept_id], [status], [is_deleted]) VALUES (N'1203503640757788674', N'1123598821738675201', N'1123598813738675201', N'1', N'0'), (N'1203503653323923458', N'1123598821738675202', N'1123598813738675202', N'1', N'0'), (N'1203503663402835969', N'1123598821738675203', N'1123598813738675202', N'1', N'0'), (N'1203503672911323137', N'1123598821738675204', N'1123598813738675202', N'1', N'0')
GO
...
-- ----------------------------
-- Primary Key structure for table blade_api_key
-- ----------------------------
ALTER TABLE [dbo].[blade_api_key] ADD CONSTRAINT [PK__blade_ap__3213E83FA19CB62A] PRIMARY KEY CLUSTERED ([id])
...
-- ----------------------------
-- Primary Key structure for table blade_api_key_log
-- ----------------------------
ALTER TABLE [dbo].[blade_api_key_log] ADD CONSTRAINT [PK__blade_akl__3213E83FB29DC73B] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table blade_auth_lock
-- ----------------------------
ALTER TABLE [dbo].[blade_auth_lock] ADD CONSTRAINT [PK__blade_au__3213E83F5A846B65] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO

-- ----------------------------
-- Primary Key structure for table blade_auth_log
-- ----------------------------
ALTER TABLE [dbo].[blade_auth_log] ADD CONSTRAINT [PK__blade_ahl__3213E83F08D2C4B7] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table blade_code_setting
-- ----------------------------
ALTER TABLE [dbo].[blade_code_setting] ADD CONSTRAINT [PK__blade_co__3213E83FBC549958] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table blade_job_info
-- ----------------------------
ALTER TABLE [dbo].[blade_job_info] ADD CONSTRAINT [PK__blade_jo__3213E83F035993DD] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table blade_job_server
-- ----------------------------
ALTER TABLE [dbo].[blade_job_server] ADD CONSTRAINT [PK__blade_jo__3213E83FD05FD0EB] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table blade_record_data
-- ----------------------------
ALTER TABLE [dbo].[blade_record_data] ADD CONSTRAINT [PK__blade_re__3213E83F4ED97820] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
ON [PRIMARY]
GO
