...
(2007600000000000007, 2007600000000000001, 'contract_create_template', '合同创建模板', 'menu', '/contract/create-template', 'iconfont iconicon_edit', 4, 1, 0, 1, 'views/contract/create-template', '合同创建模板入口', 0),
(2007600000000000008, 2007600000000000001, 'contract_print_template', '合同打印模板', 'menu', '/contract/print-template', 'iconfont icon-printer', 5, 1, 0, 1, 'views/contract/print-template', '合同打印模板入口', 0),
(2007600000000000005, 2007600000000000001, 'contract_archive', '合同归档', 'menu', '/contract/archive', 'iconfont iconicon_doc', 6, 1, 0, 1, 'views/contract/archive', '合同档案聚合查看', 0)
