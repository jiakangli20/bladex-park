...
VALUES
  ...
  (1963598815738675505, 1963598815738675501, 'rent_control_room_edit', '编辑房间', 'edit', '/api/blade-park/room/submit', 'form', 4, 2, 2, 1, '', NULL, 0),
  (1963598815738675506, 1963598815738675501, 'rent_control_room_delete', '删除房间', 'delete', '/api/blade-park/room/remove', 'delete', 5, 2, 3, 1, '', NULL, 0),
  (1963598815738675507, 1963598815738675501, 'rent_control_room_status', '状态流转', 'status', '/api/blade-park/room/change-status', 'retweet', 6, 2, 2, 1, '', NULL, 0),
  (1963598815738675508, 1963598815738675501, 'rent_control_room_sync', '同步小程序', 'sync', '/api/blade-park/room/sync-mini', 'cloud-upload', 7, 2, 2, 1, '', NULL, 0),
  (1963598815738675509, 1963598815738675501, 'rent_control_workorder_list', '工单刷新', 'workorder-list', '/api/blade-park/rent-control/workorders', 'reload', 8, 2, 1, 1, '', NULL, 0),
  (1963598815738675510, 1963598815738675501, 'rent_control_workorder_report', '上报工单', 'workorder-report', '/api/blade-park/rent-control/workorders/report', 'plus', 9, 2, 1, 1, '', NULL, 0);
