-- 园区管理 / 房源管理菜单与按钮权限
-- 执行库：bladex_boot
-- 说明：仅新增房源管理菜单与超级管理员授权，不改动 ics_park / ics_building / ics_floor / ics_room 表结构。
...
VALUES
  (1963598815738675701, 1963598815738675401, 'floor', '房源管理', 'menu', '/park/floor', 'iconfont icon-caidanguanli', 4, 1, 0, 1, '', NULL, 0),
