...
VALUES
  ...
  (1890000000003000201, 1890000000003000200, 'settlement_project_approval_view', '查看', 'view', '/settlement/project-approval/view', 'file-text', '', 1, 2, 2, 1, NULL, 0),
  (1890000000003000202, 1890000000003000200, 'settlement_project_approval_form', '审批表', 'form', '/settlement/project-approval/form', 'file', '', 2, 2, 2, 1, NULL, 0),
  (1890000000003000203, 1890000000003000200, 'settlement_project_approval_approve', '通过', 'approve', '/api/blade-approval/project/approve', 'check', '', 3, 2, 2, 1, NULL, 0),
  (1890000000003000204, 1890000000003000200, 'settlement_project_approval_reject', '驳回', 'reject', '/api/blade-approval/project/reject', 'close', '', 4, 2, 2, 1, NULL, 0),
  (1890000000003000205, 1890000000003000200, 'settlement_project_approval_transfer', '转审', 'transfer', '/api/blade-approval/project/transfer', 'share', '', 5, 2, 2, 1, NULL, 0),
  (1890000000003000206, 1890000000003000200, 'settlement_project_approval_resubmit', '重新提交', 'resubmit', '/api/blade-approval/project/resubmit', 'refresh', '', 6, 2, 2, 1, NULL, 0),
  (1890000000003000207, 1890000000003000200, 'settlement_project_approval_archive', '归档', 'archive', '/api/blade-approval/project/archive', 'folder', '', 7, 2, 2, 1, NULL, 0),
...
FROM (
  ...
  UNION ALL SELECT 1890000000004300019, 1123598816738675201, 1890000000001000100
) t
WHERE NOT EXISTS (
  SELECT 1
