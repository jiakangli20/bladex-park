...
public interface WfProcessConstant {
	...
	String HTTP_SERVICE_TASK = "httpServiceTask";

	String SHELL_SERVICE_TASK = "shellServiceTask";

	String MAIL_SERVICE_TASK = "mailServiceTask";
	...
	String COMMENT_TYPE_DELETE_PROCESS = "deleteProcessComment";

	String COMMENT_TYPE_SKIP_COMMENT = "skipComment";
	...
	String TASK_VARIABLE_ASSIGNEE = "wf_assignee";

	String TASK_VARIABLE_COPY_USER = "copyUser";

	String TASK_VARIABLE_APPOINT = "wf_appoint";

	String TASK_VARIABLE_NOTICE = "wf_notice";
	...
	String TASK_VARIABLE_PLATFORM = "wf_platform";

	String TASK_VARIABLE_FORM_OPTION = "wf_form_option";

	String TASK_VARIABLE_FORM_VARIABLE = "wf_form_variable";

	String TASK_VARIABLE_SKIP = "wf_skip";

	String TASK_VARIABLE_LATEST_TASK_ASSIGNEE = "wf_latest_task_assignee";
