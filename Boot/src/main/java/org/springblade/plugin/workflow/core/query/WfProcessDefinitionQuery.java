...
public class WfProcessDefinitionQuery extends AbstractQuery<WfProcessDefinitionQuery, ProcessDefinition> {
	...
	private static final String STATEMENT_NAMESPACE = "org.flowable.engine.impl.persistence.entity.ProcessDefinitionEntityImpl";
	private static final String SELECT_PROCESS_DEFINITION_COUNT_BY_QUERY_CRITERIA =
		STATEMENT_NAMESPACE + ".selectWfProcessDefinitionCountByQueryCriteria";
	private static final String SELECT_PROCESS_DEFINITIONS_BY_QUERY_CRITERIA =
		STATEMENT_NAMESPACE + ".selectWfProcessDefinitionsByQueryCriteria";
	protected String id;
	...
	public long executeCount(CommandContext commandContext) {
		return (long) CommandContextUtil.getDbSqlSession(commandContext).selectOne(SELECT_PROCESS_DEFINITION_COUNT_BY_QUERY_CRITERIA, this);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<ProcessDefinition> executeList(CommandContext commandContext) {
		return CommandContextUtil.getDbSqlSession(commandContext).selectList(SELECT_PROCESS_DEFINITIONS_BY_QUERY_CRITERIA, this);
	}
