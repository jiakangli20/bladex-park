...
public interface IWfFormService extends BaseService<WfForm> {
	...
	Map<String, Object> getFormByProcessDefKey(String processDefKey);
	...
	void saveDeploymentForm(String formKey, String deployId, String tenantId, List<WfDeploymentForm> forms);

	void saveIndepDeploymentForm(Collection<FlowElement> elements, String deployId, String tenantId);

	void saveIndepDeploymentForm(Collection<FlowElement> elements, String deployId, String tenantId, List<WfDeploymentForm> forms);
